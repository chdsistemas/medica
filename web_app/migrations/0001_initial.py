# Generated by Django 5.1.2 on 2025-03-27 18:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('PREMIUM', 'Paciente Premium'), ('GENERAL', 'Paciente General')], default='GENERAL', max_length=20)),
            ],
            options={
                'db_table': 'pacientes',
            },
            bases=('web_app.persona',),
            managers=[
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especialidad', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='web_app.especialidad')),
            ],
            options={
                'db_table': 'medicos',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medico', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='web_app.medico')),
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='web_app.paciente')),
            ],
            options={
